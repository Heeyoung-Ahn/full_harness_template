...
3. Codex 또는 Antigravity에서 복제한 그 폴더 자체를 workspace root로 엽니다.
...
6. 실제 프로젝트를 시작할 때는 `PROJECT_START_CHECKLIST.md`를 따라 `template_mode: true` 상태를 `template_mode: false` 상태로 전환합니다.
