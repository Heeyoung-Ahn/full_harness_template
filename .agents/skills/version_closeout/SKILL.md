...
- closeout 시작 전에 `python scripts/check_closeout_readiness.py --mode version_closeout`를 실행합니다.
...
- 새 버전 문서 뼈대를 만든 뒤 `python scripts/check_artifact_schema.py`를 실행해 기본 구조가 깨지지 않았는지 확인합니다.
