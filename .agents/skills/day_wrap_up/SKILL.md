...
- 정리 작업을 시작하기 전에 `python scripts/check_closeout_readiness.py --mode day_wrap_up`를 실행합니다.
...
- 마감 기록 직전 `python scripts/check_artifact_schema.py`, `python scripts/check_current_state_sync.py`, `python scripts/check_handoff_limits.py`를 실행합니다.
